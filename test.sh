...
assert 3 'int main() { if (1-1) return 2; else return 3; return 4; }'
assert 2 'int main() { if (1) return 2; else return 3; return 4; }'
assert 2 'int main() { if (2-1) return 2; else return 3; return 4; }'
...
assert 3 'int main() { int x; x=3; int *y; y=&x; int **z; z=&y; return *(&z-2); }'
...
assert 5 'int main() { int x[3]; x[0]=3; x[1]=4; x[2]=5; return 2[x]; }'
